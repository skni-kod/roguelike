...
const K1 = preload("res://scenes/equipment/weapons/melee/effects/Blood_particles_1.tscn") #pobieramy particle do umiejek
const K2 = preload("res://scenes/equipment/weapons/melee/effects/Blood_particles_2.tscn")
