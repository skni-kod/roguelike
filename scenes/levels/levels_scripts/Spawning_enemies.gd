...
var all_enemies = {
		0 : preload("res://Scenes/Actors/Big_Devil/Big Devil.tscn"),
		1 : preload("res://Scenes/Actors/Cuck/cuck.tscn"),
		2 : preload("res://Scenes/Actors/Cuckshooter/cuckshooter.tscn"),
		3 : preload("res://Scenes/Actors/Goblin_Shaman/goblin_shaman.tscn"),
		4 : preload("res://Scenes/Actors/Lil_Devil/Lil Devil.tscn"),
		5 : preload("res://Scenes/Actors/Little_Goblin/Little_Goblin.tscn"),
		6 : preload("res://Scenes/Actors/Potato/Potato.tscn"),
		7 : preload("res://Scenes/Actors/Slime/Slime.tscn"),
		8 : preload("res://Scenes/Actors/Snot/Snot.tscn"),
		9 : preload("res://Scenes/Actors/Orc/Orc.tscn"),
	}
	...
	if body.name == "Player": 
		...
		if not current_id in id_list and not boss and not is_sklep: #losowanie przeciwników do poziomu
			...
			if odwiedzony == false:
				weapon()
				potion()
				var popup = load("res://Scenes/ui/ui_scenes/Sklep_ceny.tscn")
...
func potion():
		var ptn
		ptn = load("res://Scenes/loot/potions/potions_scenes/60healthPotion.tscn")
		ptn = ptn.instance()
...
func weapon():
	...
	weapon = load("res://Scenes/loot/objects/objects_scenes/Weapon.tscn") #Ładuje scenę broni do zmiennej 
