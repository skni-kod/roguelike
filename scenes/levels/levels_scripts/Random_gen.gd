...
var oneDoor = 0
var drawn = false
var scene = load("res://Scenes/levels/levels_scenes/Room.tscn") #wczytywanie sceny pokoju
var player = load("res://Scenes/Actors/Player/Player.tscn") #wczytywanie sceny playera
